module ApplicationHelper
  ...
  def show_feedback_status(apply)
    ...
    elsif apply.feedback && apply.feedback.notifications.first.user_id == current_user.id && apply.verify.user_id == current_user.id && apply.feedback.distribute_advice.empty?
